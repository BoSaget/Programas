...
//	$l_pword = md5($l_pword);
	...
	$conexion = new mysqli("localhost", "intrang4_soloav", "SA2012pc_WEB", "intrang4_Control_Usuarios");

	$consulta = "SELECT Rol from Usuarios where Nombre = '$l_un_em' and Contraseña = '$l_pword'";
	...
	if ($resultado) { 
		...
		if($fila ['Rol']!=""){
			$_SESSION['name']=$l_un_em;
			$_SESSION['uid'] = 1;
			//echo "<script>document.location.href='".$url."';</script>";
			echo "<script>document.location.href='./roles.php';</script>";
		}else{
		
			$consulta_2 = "SELECT Rol from Usuarios where Nombre = '$l_un_em' and Contraseña = '$l_pword'";
			...
			if ($resultado_2) { 
				...
				if($fila_2 ['Rol']!=""){
					...
					$consulta_3 = "SELECT Rol from Usuarios where Nombre = '$l_un_em' and Contraseña = '$l_pword'";
					...
					if ($resultado_3) { 
						...
						if($fila_3 ['Rol']!=""){
							...
							$consulta_4 = "SELECT Rol from Usuarios where Nombre = '$l_un_em' and Contraseña = '$l_pword'";
